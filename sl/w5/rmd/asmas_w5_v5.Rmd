...
```{r SubsetSelection, conv.odg=TRUE, odg.path="../odg", odg.graph.cache=TRUE,fig.align='center', out.width='8cm'}
knitr::include_graphics(path = "SubsetSelection")
```
...
```{r Regularisierung, conv.odg=TRUE, odg.path="../odg", odg.graph.cache=TRUE,fig.align='center', out.width='10cm'}
knitr::include_graphics(path = "Regularisierung")
```
...
```{r Lasso, conv.odg=TRUE, odg.path="../odg", odg.graph.cache=TRUE,fig.align='center', out.width='10cm'}
knitr::include_graphics(path = "Lasso")
```
...
```{r Ridge, conv.odg=TRUE, odg.path="../odg", odg.graph.cache=TRUE,fig.align='center', out.width='10cm'}
knitr::include_graphics(path = "Ridge")
```
