...
bref <- c(bibentry(
  ...
  bibentry(
    ...
    chapter = "Genomic Best Linear Unbiased Prediction (gBLUP) for the Estimation of Genomic Breeding Values",
    author = c(as.person("S. A. Clerk"), as.person("J. van der Werf")),
    editor = c(as.person("C. Gondro"), as.person("J.  van der Werf"), as.person("B. Hayes")),
    year = "2013",
    publisher = "Springer",
