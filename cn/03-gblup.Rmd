...
Im Kapitel 13 von [@GWH2013] ist ein R-Programm zur Berechnung der genomischen Verwandtschaftsmatrix aufgeführt. Wir wollen dieses Programm analysieren und präsentieren auch eine alternative Art der Berechnung der genomischen Verwandtschaftsmatrix. 
...
Das gezeigte Programm zur Berechnung der genomischen Verwandtschaftsmatrix aus [@GWH2013] kann vereinfacht werden. Insbesondere können die `for`-loops durch einfachere Funktionen und vektorisierte Berechnungen ersetzt werden. Das folgende Programm berechnet die gleiche genomische Verwandtschafsmatrix. 
